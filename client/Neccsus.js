...
var author$project$Main$LoadedRemoteMessages = function (a) {
...
var author$project$Main$getMessages = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$LoadedRemoteMessages, author$project$Main$decodeMessages),
...
var author$project$Main$LoadedRemoteMessage = function (a) {
	...
	return elm$http$Http$post(
		{
			...
			expect: A2(elm$http$Http$expectJson, author$project$Main$LoadedRemoteMessage, author$project$Main$decodeMessage),
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								messages: author$project$Main$Messages(messages)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								messages: author$project$Main$Error('something went bad')
							}),
						elm$core$Platform$Cmd$none);
				}
					...
					if (_n1.$ === 'Messages') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									messages: author$project$Main$Messages(
										_Utils_ap(
											messages,
											_List_fromArray(
												[message])))
...
var author$project$Main$decodeValue = A2(
...
var author$project$Main$decodeValueOnEnter = A2(
	...
	A3(elm$json$Json$Decode$map2, elm$core$Tuple$pair, author$project$Main$decodeKey, author$project$Main$decodeValue));
...
var author$project$Main$onEnterKey = function (func) {
	return A2(
		elm$html$Html$Events$on,
		'keypress',
		A2(elm$json$Json$Decode$map, func, author$project$Main$decodeValueOnEnter));
};
var author$project$Main$onKeyPress = function (func) {
	return A2(
		elm$html$Html$Events$on,
		'keypress',
		A2(elm$json$Json$Decode$map, func, author$project$Main$decodeValue));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(message.author)
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
	...
	return {
		body: _List_fromArray(
			[
				...
				switch (_n0.$) {
					case 'Loading':
						return elm$html$Html$text('Loading messages');
					case 'Error':
						var message = _n0.a;
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('Type your message here'),
						elm$html$Html$Attributes$value(model.newMessage),
						author$project$Main$onKeyPress(author$project$Main$UpdateNewMessage),
						author$project$Main$onEnterKey(author$project$Main$SubmitNewMessage)
					]),
				_List_Nil)
			]),
		title: 'NeCCSus'

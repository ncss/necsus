...
bots.set(room='', name='Echo', url='https://neccsus-bot.herokuapp.com/neccsus/command')
bots.set(room='', name='Repeat', url='https://neccsus-bot.herokuapp.com/neccsus/command')
